...
- `stoch_assignments` directory: ECE302 (Probability & Stochastic Processes) assignments
- `dsp_assignments` directory: ECE310 (Digial Signal Processing) assignments
